...
set view map
unset colorbox
set xrange [  -0.08035:   0.08035]
set yrange [  -0.13917:   0.13917]
set pm3d interpolate 2,2
set label 1 'Spin texture' at graph 0.25, 1.10 front
splot 'arc.dat_l' u 1:2:3 w pm3d, \
     'spindos.dat_l' u 1:2:(0):($3/5.00):($4/5.00):(0)  w vec  head lw 5 lc rgb 'orange' front
